    ...
    items: [
      {
        ...
        children: [
          ...
          },
          {
            ...
            desc: "과목×학년 칸마다 검사지를 걸고 회차를 연다. 초안이 남아 있으면 열지 못한다",
          },
          {
 ...
 *
 *   여기 ItemRow에는 S단계(S1~S4)도 학년도 성취기준도 없다. 회차 편성이 고르는 것은
 *   「국어 3·4학년의 S2 문항」이라, 이 목록을 화면에 그리면 편성 화면과 은행이 서로
...
> = {
  ...
  "report-assets": {
    ...
    todo: [
      ...
      "ADM-08-3 추천 자원 DB — 도서·체험·프로그램을 재능 × 학년 × 난이도로 색인",
