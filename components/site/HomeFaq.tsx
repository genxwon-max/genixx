...
const items: FaqItem[] = [
  ...
  },
  {
    ...
    a: "만 14세를 기준으로 갈립니다. 만 14세 이상이면 학생이 직접 가입해 본인 동의로 응시할 수 있습니다. 만 14세 미만이면 학생 혼자서는 가입을 끝낼 수 없고(가입 불가가 아니라 단독가입 불가입니다), 법정대리인의 동의가 확인되면 프로필이 열립니다. 그때는 학부모·기관이 발급한 8자리 접속코드와 생년월일로 들어갑니다. 어느 쪽이든 학생 화면에서는 결제 정보나 형제자매의 결과가 보이지 않습니다.",
  },
  {
    q: "아이의 답변은 누가 보게 되나요?",
