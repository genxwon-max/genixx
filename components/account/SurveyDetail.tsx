  ...
  return (
    <>
      ...
      <div className={`${card} divide-y divide-slate-100`}>
        {surveyKeys.map((key) => (
          <SurveyRow
            ...
            /* 학부모 설문은 등록할 때 받아 둔 보호자 연락처에서 출발한다.
      ...
      <p className="mt-4 text-[12.5px] leading-[1.7] text-soft-muted">
        문자로 보낸 링크는 로그인 없이 열립니다. 함께 보시는 분이나 교사께 계정을 따로
        만들어 달라고 하지 않으셔도 됩니다. 평소 모습 그대로 답하시면 되고, 보호자의 양육 태도를
