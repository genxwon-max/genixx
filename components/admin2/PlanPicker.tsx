 ...
 *
 * ── 왜 격자가 아니라 목록인가 ──
 * 한동안 과목 × 학년군 여섯 칸을 체크상자 격자로 두었다. 고르는 일은 빨랐지만 두 가지를
 * 못 했다. 첫째, **차례를 못 정한다** — 응시자가 국어부터 보는지 수학부터 보는지가 격자에는
 * 없다. 둘째, 학년군이 과목마다 따로 서서 「이번 회차는 3·4학년군만」이라는 흔한 편성을
 * 여섯 칸 중 셋을 꺼서 표현해야 했다.
 *
 * ── 학년군은 하나 ──
 * 고르개 하나로 받는다. 한 회차가 한 학년군을 본다 — 3·4학년군과 5·6학년군은 응시 기간도
 * 문항 재고도 따로 굴러가고, 둘을 한 회차에 묶으면 제출률·판정 진행이 두 학년군의 평균이
