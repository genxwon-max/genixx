 ...
 * 화면의 일뿐이다 — 출제는 「남은 칸」, 검수는 「AI 사전 검수」, 은행은 「정답률」.
 *
...
/* ───────────────────────── 표를 직접 짠 화면을 위한 조각 ─────────────────────────
   앵커 문항(ADM-04-2)·검사지 조립(ADM-04-3)·문항 회전(ADM-04-4)은 고르기와 조립
   같은 제 일이 있어 DataList로 갈아입히지 않았다. 다만 문항번호·단계·상태처럼
   목록과 겹치는 칸은 같은 모양이어야 한다 — 한 페이지(문항 은행) 안에서 같은
   문항이 표마다 다르게 보이면 그게 같은 것인지 먼저 의심하게 된다. */
